...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-linen/40 px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-3xl">
        ...
        >
          <span className="font-mono text-xs uppercase tracking-caption text-cognac">{CONTACT.eyebrow}</span>
